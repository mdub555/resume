...
\begin{cventries}
  ...
  %   {%
  %     I was offered a scholarship for front-end web development that allows me
  %     to learn website development with JavaScript and HTML5. This challenge
  %     scholarship can lead to a longer course of the same subject.
  %   }
  \cventry%
